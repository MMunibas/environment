...
open unit 10  read form name @name_@num_@proc.res
set proc dyna
open write unit 11 file name /data/yinc/ir/long_asw_armd_kky/@name_@num_@proc.dcd
open write unit 12 file name /data/yinc/ir/long_asw_armd_kky/@name_@num_@proc.vcd
open unit 13 write form name @name_@num_@proc.res

DYNA RESTART VERL NSTE 100000000  TIME 0.0001 inbfrq 10 IMGFRQ 10 -
