...
! Topology
OPEN UNIT 1 CARD READ NAME top_all22_prot_c2.inp
READ RTF CARD UNIT 1
CLOSE UNIT 1

OPEN UNIT 1 FORMatted READ NAME par_all22_prot_c2.inp
...
GEO  sphere quartic -
     ...
     force 0.2 droff 50.0 p1 2.25 sele bynu 9:1364 end
END

coor orient MASS sele bynu 9:1364 end

WRITE COOR CARD NAME check_@name_@num.cor

wkky sele  bynu 9:1364 end
energy
